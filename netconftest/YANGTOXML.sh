...
# 2020-01-05
################################################
PATH="/sbin:/bin:/usr/sbin:/usr/bin:/usr/local/bin:/home/bitnara/vdjangoenv/bin:/home/bitnara/vdjangoenv/bin/pyang";
echo ""
VERSION=`pyang -v`
echo "- pyang version: "$VERSION 
CWD=`pwd`
echo "- Current directory: "$CWD
YANG_SRC_DIR="/home/bitnara/netconftest/yang/vendor/cisco/xe/1731"
echo "- YANG source directory: "$YANG_SRC_DIR
CMD="pyang -p /home/bitnara/netconftest/yang -f sample-xml-skeleton"
# echo "====================================== YANG LIST ======================================"
# cd $YANG_SRC_DIR
